...
import {presets} from '../../astral-background/upstream-shadergradient/packages/shadergradient/src/presets.ts';
import {shaderMaterial} from '../../astral-background/upstream-shadergradient/packages/shadergradient/src/shaders/shaderMaterial.ts';
import {vertex,fragment} from '../../astral-background/upstream-shadergradient/packages/shadergradient/src/shaders/defaults/sphere/index.ts';
import * as cosmic from '../../astral-background/upstream-shadergradient/packages/shadergradient/src/shaders/cosmic/sphere/index.ts';
